...
if __name__ == "__main__":
    plot_group(
        SIGNAL_REWARDS,
        title="Exp1: Signal Quality — Reward vs Timesteps",
        output_path=FIGURES_DIR / "learning_curves_signal.png",
    )
    plot_group(
        TIMING_REWARDS,
        title="Exp2: Temporal Structure — Reward vs Timesteps",
        output_path=FIGURES_DIR / "learning_curves_timing.png",
    )
